-- Dados iniciais extraídos de helpdesk_prefeitura.sql
-- Contém somente comandos INSERT INTO.
-- A estrutura das tabelas deve ser criada pelas migrations.
-- Gerado a partir do dump fornecido pelo usuário.
